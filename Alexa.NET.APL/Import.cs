...
namespace Alexa.NET.Response.APL
{
    public class Import:IEquatable<Import>
    {
        ...
        public static Import AlexaStyles => new Import("alexa-styles","1.2.0");
        public static Import AlexaViewportProfiles => new Import("alexa-viewport-profiles", "1.2.0");
        public static Import AlexaLayouts => new Import("alexa-layouts","1.3.0");
